...
export class CompatibleATNDeserializer extends ATNDeserializer {
	 ...
	 */
    static isFeatureSupported(feature: UUID, actualUuid: UUID) {
	...
	public deserialize(@NotNull data: Uint16Array): ATN {
		...
		let supportsLexerActions: boolean = CompatibleATNDeserializer.isFeatureSupported(CompatibleATNDeserializer.ADDED_LEXER_ACTIONS2, uuid);
		...
		p = this.deserializeSets2(data, p, sets, CompatibleATNDeserializer.getUnicodeDeserializer2(UnicodeDeserializingMode.UNICODE_BMP));
        ...
        if (CompatibleATNDeserializer.isFeatureSupported(CompatibleATNDeserializer.ADDED_UNICODE_SMP2, uuid)
			...
			p = this.deserializeSets2(data, p, sets, CompatibleATNDeserializer.getUnicodeDeserializer2(UnicodeDeserializingMode.UNICODE_SMP));
		}
	...
	private deserializeSets2(data: Uint16Array, p: number, sets: IntervalSet[], unicodeDeserializer: UnicodeDeserializer): number {
