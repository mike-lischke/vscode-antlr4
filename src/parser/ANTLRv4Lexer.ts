...
export class ANTLRv4Lexer extends LexerAdaptor {
    ...
    public static readonly ruleNames = [
        ...
        "OPTIONS", "TOKENS", "CHANNELS", "WSNLCHARS", "IMPORT", "FRAGMENT", 
        ...
        "Question", "Star", "Plus", "PlusAssign", "Underscore", "Pipe", 
    ...
    private BEGIN_ARGUMENT_action(localContext: antlr.ParserRuleContext | null, actionIndex: number): void {
        switch (actionIndex) {
        case 0:
    ...
    private END_ARGUMENT_action(localContext: antlr.ParserRuleContext | null, actionIndex: number): void {
        switch (actionIndex) {
        case 1:
    ...
    private END_ACTION_action(localContext: antlr.ParserRuleContext | null, actionIndex: number): void {
        switch (actionIndex) {
        case 2:
